...
//   protected $skipValidation     = false;
    ...
    public function getServiceRecord($emp_id){    
      $sql = '
        SELECT *, 
        (SELECT amount * 12 FROM salary_schedule_tbl 
        WHERE nbc_id = sr.sr_nbc_id AND salary_grade = plant.salary_grade
        AND step = sr.sr_step
        GROUP BY sal_sched_id) as salary 
        FROM service_record_tbl as sr 
        ...
        LEFT JOIN station_tbl as st ON st.station_id = sr.sr_station_id
