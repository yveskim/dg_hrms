...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2024 at 03:24 AM
...
(19, '3434543543', 'Teacher I', 11, '2023-12-01', 1, 2, '2023-12-08 12:20:36', '2024-01-02 09:33:00'),
...
CREATE TABLE `service_record_tbl` (
  ...
  `loa_set_by` int(11) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL,
  `created_at` date NOT NULL,
  `updated_at` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `service_record_tbl`
  MODIFY `sr_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
ALTER TABLE `service_record_tbl`
  ...
  ADD CONSTRAINT `service_record_tbl_ibfk_6` FOREIGN KEY (`loa_set_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
