...
INSERT INTO `advisery_tbl` (`adv_id`, `emp_id`, `sec_id`, `program_id`, `sy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 3296, 2, 5, 1, '2023-04-27 22:02:17', '2023-04-27 22:02:17', NULL);
...
CREATE TABLE `designation_tbl` (
  ...
  `emp_id` int(11) NOT NULL,
  `designation_title` varchar(60) NOT NULL,
  `des_description` varchar(200) NOT NULL,
...
(2, 3294, 1, '2023-04-19', 0, '2023-04-26 15:48:44', '2023-04-26 22:23:41'),
(4, 3295, 1, '2023-04-26', 1, '2023-04-26 22:23:28', '2023-04-26 22:23:41');
...
(11, 3294, 3, 1, 1, '2023-04-19', 0, '2023-04-26 22:01:23', '2023-04-26 22:24:11'),
(12, 3295, 8, 1, 1, '2023-04-20', 1, '2023-04-26 22:24:08', '2023-04-26 22:24:11');
...
INSERT INTO `employee_program_tbl` (`emp_prog_id`, `emp_id`, `prog_id`, `date_assigned`, `is_current`) VALUES
(1, 3295, 5, '2023-04-13', 0),
(2, 3295, 5, '2023-04-14', 1);
...
INSERT INTO `program_tbl` (`prog_id`, `program_title`, `description`, `program_head`, `cat_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(5, 'STVEP', 'Strengthened Technological-Vocational Education Program', 3295, 1, '2023-04-27 14:23:42', '2023-04-27 14:23:42', NULL);
...
CREATE TABLE `section_tbl` (
  ...
  `sec_title` varchar(120) NOT NULL,
  `grade_level_id` smallint(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `section_tbl` (`sec_id`, `sec_title`, `grade_level_id`) VALUES
(1, 'BYRON', 4),
(2, 'COOPER', 1);
...
--
-- Table structure for table `student_advisery_tbl`
--

CREATE TABLE `student_advisery_tbl` (
  `stud_adv_id` int(11) NOT NULL,
  `adv_id` int(11) NOT NULL,
  `en_id` bigint(20) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
...
--
-- Dumping data for table `student_advisery_tbl`
--

INSERT INTO `student_advisery_tbl` (`stud_adv_id`, `adv_id`, `en_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 3, 130, '2023-04-27 22:02:47', '2023-04-27 22:02:47', NULL),
(2, 3, 131, '2023-04-27 22:02:47', '2023-04-27 22:02:47', NULL),
(3, 3, 132, '2023-04-27 22:02:47', '2023-04-27 22:02:47', NULL);
...
ALTER TABLE `program_tbl`
  ...
  ADD KEY `program_head` (`program_head`),
...
--
-- Indexes for table `student_advisery_tbl`
--
ALTER TABLE `student_advisery_tbl`
  ADD PRIMARY KEY (`stud_adv_id`),
...
--
ALTER TABLE `employee_department_tbl`
  MODIFY `emp_dept_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `employee_position_tbl`
--
ALTER TABLE `employee_position_tbl`
  MODIFY `emp_pos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `employee_program_tbl`
--
ALTER TABLE `employee_program_tbl`
  MODIFY `emp_prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `employee_t`
--
ALTER TABLE `employee_t`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3297;
...
--
ALTER TABLE `program_tbl`
  MODIFY `prog_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `section_tbl`
  MODIFY `sec_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `student_advisery_tbl`
--
ALTER TABLE `student_advisery_tbl`
  MODIFY `stud_adv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `advisery_tbl`
  ADD CONSTRAINT `advisery_tbl_ibfk_2` FOREIGN KEY (`sy`) REFERENCES `school_year_tbl` (`sy_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `advisery_tbl_ibfk_3` FOREIGN KEY (`emp_id`) REFERENCES `employee_t` (`emp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `advisery_tbl_ibfk_4` FOREIGN KEY (`sec_id`) REFERENCES `section_tbl` (`sec_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `advisery_tbl_ibfk_5` FOREIGN KEY (`program_id`) REFERENCES `program_tbl` (`prog_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `designation_tbl`
  ADD CONSTRAINT `designation_tbl_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employee_t` (`emp_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `program_tbl`
  ADD CONSTRAINT `program_tbl_ibfk_1` FOREIGN KEY (`program_head`) REFERENCES `employee_t` (`emp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `section_tbl`
  ADD CONSTRAINT `section_tbl_ibfk_2` FOREIGN KEY (`grade_level_id`) REFERENCES `grade_level_tbl` (`grade_level_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `student_advisery_tbl`
--
ALTER TABLE `student_advisery_tbl`
  ADD CONSTRAINT `student_advisery_tbl_ibfk_1` FOREIGN KEY (`adv_id`) REFERENCES `advisery_tbl` (`adv_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `student_advisery_tbl_ibfk_2` FOREIGN KEY (`en_id`) REFERENCES `enrollment_tbl` (`en_id`) ON DELETE CASCADE ON UPDATE CASCADE;
