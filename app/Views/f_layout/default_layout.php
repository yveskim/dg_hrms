...
<head>
    ...
    <!-- Metro 4 -->
    <link rel="stylesheet" href="<?php echo base_url('assets/pandora/vendors/metro4/css/metro-all.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/pandora/css/index.css'); ?>">
...
<body class="m4-cloak h-vh-100">
  <form class="" action="sign_out" method="post" id="sign-out"></form>
  <div data-role="navview" data-toggle="#paneToggle" data-expand="xl" data-compact="lg" data-active-state="true">
    <div class="navview-pane">
        <div class="bg-cyan d-flex flex-align-center">
            ...
            <h2 class="text-light m-0 fg-white pl-7" style="line-height: 52px">INHS</h2>
        </div>

        <div class="suggest-box">
            <div class="data-box">
                <img src="<?= 'upload/'.$userInfo['emp_image']; ?>" class="avatar">
                <div class="ml-4 avatar-title flex-column">
                    <a href="#" class="d-block fg-white text-medium no-decor"><span class="reduce-1"><?= $userInfo['emp_fname'].' '.$userInfo['emp_mname'].' '. $userInfo['emp_lname']; ?></span></a>
                    <p class="m-0"><span class="fg-green mr-2">&#x25cf;</span><span class="text-small">online</span></p>
                </div>
            </div>
            <img src="<?php echo base_url('assets/pandora/images/jek_vorobey.jpg'); ?>" class="avatar holder ml-2">
        </div>
        ...
        <div data-role="appbar" class="pos-absolute bg-darkCyan fg-white">
            ...
            <div class="app-bar-container ml-auto">
                ...
                <div class="app-bar-container">
                    <a href="#" class="app-bar-item">
                        <img src="<?= 'upload/'.$userInfo['emp_image']; ?>" class="avatar">
                        <span class="ml-2 app-bar-name"> Welcome! <?= $userInfo['emp_fname']; ?></span>
                    </a>
                    <div class="user-block shadow-1" data-role="collapse" data-collapsed="true">
                        <div class="bg-darkCyan fg-white p-2 text-center">
                            <img src="<?= 'upload/'.$userInfo['emp_image']; ?>" class="avatar">
                            <div class="h4 mb-0"> <?= $userInfo['emp_fname']; ?></div>
                            <div><?= $userInfo['emp_email']; ?></div>
                        </div>
                        ...
                        <div class="bg-white d-flex flex-justify-between flex-equal-items p-2 bg-light">
                            <button class="button mr-1" id="btn-profile">Profile</button>
                            <button class="button ml-1" type="submit" form="sign-out">Sign out</button>
                        </div>
                    </div>
                </div>
                <a href="#" class="app-bar-item">
    ...
    <script src="<?php echo base_url('assets/pandora/vendors/chartjs/Chart.bundle.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/pandora/vendors/qrcode/qrcode.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/pandora/vendors/jsbarcode/JsBarcode.all.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/pandora/vendors/ckeditor/ckeditor.js'); ?>"></script>
    <script src="<?php echo base_url('assets/pandora/vendors/ckeditor/ckeditor.js.map'); ?>"></script>

    <script src="<?php echo base_url('assets/pandora/vendors/jquery/jquery-3.4.1.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/pandora/vendors/metro4/js/metro.min.js'); ?>"></script>
