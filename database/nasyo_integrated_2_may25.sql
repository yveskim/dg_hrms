...
(14, 3297, 9, '2023-05-01', 0, 1, '2023-05-02 13:24:02', '2023-05-12 15:24:54', NULL),
...
(22, 3297, 6, '2023-05-03', 1, 1, '2023-05-12 15:24:51', '2023-05-12 15:24:54', NULL);
...
(33, 138, 1, 1, 1, 1, 1, 'OE', '', 1, 274, '2023-05-16 15:45:50', '2023-05-16 15:45:50', NULL),
(34, 140, 1, 1, 1, 1, 1, 'OE', '', 1, 274, '2023-05-25 15:02:43', '2023-05-25 15:02:43', NULL),
(35, 141, 1, 1, 1, 1, 1, 'OE', 'FGDGDFG', 6, 274, '2023-05-25 15:08:34', '2023-05-25 15:08:34', NULL),
(36, 142, 1, 1, 1, 1, 1, 'OE', '', 5, 274, '2023-05-25 16:57:51', '2023-05-25 16:57:51', NULL);
...
(138, '23-00001', '12345678910', 'Al John', 'Dela Cruz', 'Artacho', 'Male', '1990-05-02', 'fsdfsd', '', 'Filipino', 'Roman Catholic', '', 'b-', '45', '54', '09123456789', '033-320-4361', 'aljon.artacho@gmail.com', 'al john artacho', '1684996294_0352d82fde9fdbd37f85.png', 0, '', '2023-05-13 16:19:01', '2023-05-25 16:28:52', '2023-05-25 16:28:52'),
...
(141, '23-00004', '654668865665', 'Lovelyn', 'Paborito', 'Castro', 'Female', '1985-03-07', 'sdfxcvazxc', '43547673656', 'Filipino', 'Roman Catholic', 'Hiligaynon', 'o', '65', '45', '09454433654', '', 'lovelyn.castro@gmail.com', 'lynlove castro', '1684996410_d4dda17805d95b2b64e3.jpg', 0, '', '2023-05-13 16:33:26', '2023-05-25 16:29:14', '2023-05-25 16:29:14'),
...
(144, '23-00007', '3235345253', 'Jano', 'Sarino', 'Tabor', 'Male', '1982-09-09', 'ouiououi', '23535223', 'Filipino', 'Roman Catholic', 'Hiligaynon', 'b+', '68', '76', '095746354454', '0339583533', 'jano.tabor@gmail.com', 'jano tabor', '1684996448_a625d7dbb96cfdb4b742.jpg', 0, '', '2023-05-18 14:29:39', '2023-05-25 16:29:24', '2023-05-25 16:29:24'),
(146, '23-00008', '4353535', 'John', 'Moris', 'Doe', 'Male', '2023-05-10', 'aaaaa', '345345345', 'Filipino', 'Roman Catholic', 'Hiligaynon', 'a+', '76', '45', '23565474574645', '6465456', 'john@gmail.com', 'sdfsd', '1684996294_0352d82fde9fdbd37f85.png', 1, 'asddas', '2023-05-23 11:27:36', '2023-05-25 16:28:38', '2023-05-25 16:28:38'),
(147, '23-00006', '', 'sdf', 'sdhgfdgd', 'ffdgdf', 'Male', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', NULL, 0, '', '2023-05-25 16:58:10', '2023-05-25 16:58:10', NULL);
...
(72, '23-00006', 'iloilonhs', 1, 0, 'student', 147, '2023-05-25 16:58:10', '2023-05-25 16:58:10');
...
--
ALTER TABLE `employee_program_tbl`
  MODIFY `emp_prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `enrollment_status_tbl`
  MODIFY `en_stat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `enrollment_tbl`
--
ALTER TABLE `enrollment_tbl`
  MODIFY `en_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
...
--
ALTER TABLE `household_members_tbl`
  MODIFY `hm_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `section_tbl`
  MODIFY `sec_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `student_account_t`
  MODIFY `s_account_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `student_parents_tbl`
  MODIFY `parent_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `student_program_tbl`
--
ALTER TABLE `student_program_tbl`
  MODIFY `stud_prog_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `student_school_tbl`
--
ALTER TABLE `student_school_tbl`
  MODIFY `sch_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
