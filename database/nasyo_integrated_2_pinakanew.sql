...
INSERT INTO `program_tbl` (`prog_id`, `program_title`, `description`, `program_head`, `program_logo`, `cat_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(5, 'STVEP', 'Strengthened Technological-Vocational Education Program', 3295, NULL, 1, '2023-04-27 14:23:42', '2023-04-27 14:23:42', NULL);
...
--
ALTER TABLE `section_details_tbl`
  MODIFY `sec_det_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
