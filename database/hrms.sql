...
CREATE TABLE `nbc_tbl` (
  ...
  `nbc_date` date NOT NULL,
  `nbc_title` varchar(150) NOT NULL,
  `sal_grade` varchar(5) NOT NULL,
  ...
  `step_9` decimal(8,2) NOT NULL,
  `step_10` decimal(8,2) NOT NULL,
  `step_11` decimal(8,2) NOT NULL,
  `step_12` decimal(8,2) NOT NULL,
  `step_13` decimal(8,2) NOT NULL,
  `step_14` decimal(8,2) NOT NULL,
  `step_15` decimal(8,2) NOT NULL,
  `step_16` decimal(8,2) NOT NULL,
  `step_17` decimal(8,2) NOT NULL,
  `step_18` decimal(8,2) NOT NULL,
  `step_19` decimal(8,2) NOT NULL,
  `step_20` decimal(8,2) NOT NULL,
  `step_21` decimal(8,2) NOT NULL,
  `step_22` decimal(8,2) NOT NULL,
  `step_23` decimal(8,2) NOT NULL,
  `step_24` decimal(8,2) NOT NULL,
  `step_25` decimal(8,2) NOT NULL,
  `step_26` decimal(8,2) NOT NULL,
  `step_27` decimal(8,2) NOT NULL,
  `step_28` decimal(8,2) NOT NULL,
  `step_29` decimal(8,2) NOT NULL,
  `step_30` decimal(8,2) NOT NULL,
  `step_31` decimal(8,2) NOT NULL,
  `step_32` decimal(8,2) NOT NULL,
  `step_33` decimal(8,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `service_record_tbl` (
  ...
  `sr_date_from` date NOT NULL,
  `sr_date_to` date NOT NULL,
  `plantilla_id` int(11) NOT NULL,
  `office_id` int(11) NOT NULL,
  `lvs_abs_wo_pay` decimal(8,2) NOT NULL,
...
ALTER TABLE `service_record_tbl`
  ...
  ADD KEY `separation_id` (`separation_id`),
...
ALTER TABLE `emp_plantilla_tbl`
  ...
  ADD CONSTRAINT `emp_plantilla_tbl_ibfk_2` FOREIGN KEY (`nbc_id`) REFERENCES `nbc_tbl` (`nbc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `service_record_tbl`
  ...
  ADD CONSTRAINT `service_record_tbl_ibfk_2` FOREIGN KEY (`es_processed_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `service_record_tbl_ibfk_3` FOREIGN KEY (`separation_id`) REFERENCES `emp_seperation_tbl` (`es_id`) ON DELETE CASCADE ON UPDATE CASCADE;
