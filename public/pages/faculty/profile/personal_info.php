...
<div class="card card-basic-info ">
    ...
    <div class="card-header p-2 bg-secondary">
        <div class="row">
            ...
            <button class="col-md-2 btn btn-default full-size btn-sm fs-1" id="btn-cancel-basic" type="button" >Cancel</button>
        ...
        <div class="card card-other">
            ...
            <div class="card-header p-2 bg-secondary">
                <div class="row">
                    ...
                    <button class="col-md-2 btn btn-default full-size btn-sm fs-1" id="btn-cancel-other" type="button" >Cancel</button>
        ...
        <div class="card card-contact-info">
            ...
            <div class="card-header p-2 bg-secondary">
                <div class="row">
                    ...
                    <button class="col-md-2 btn btn-default full-size btn-sm fs-1" id="btn-cancel-contact" type="button" >Cancel</button>
                    <div class="col-lg-4 float-right">
        ...
        <div class="card card-permanent-address">
            ...
            <div class="card-header p-2 bg-secondary">
                <div class="row">
                    ...
                    <button class="col-md-2 btn btn-default full-size btn-sm fs-1" id="btn-cancel-per" type="button" >Cancel</button>
                    <div class="col-lg-4 float-right">
        ...
        <div class="card card-current-address">
            ...
            <div class="card-header p-2 bg-secondary">
                <div class="row">
                    ...
                    <button class="col-md-2 btn btn-default full-size btn-sm fs-1" id="btn-cancel-cur" type="button" >Cancel</button>
                    <div class="col-lg-4 float-right">
