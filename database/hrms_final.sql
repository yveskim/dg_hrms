...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2023 at 09:34 AM
...
--
-- Table structure for table `employment_status_tble`
--

CREATE TABLE `employment_status_tble` (
...
--
-- Dumping data for table `employment_status_tble`
--

INSERT INTO `employment_status_tble` (`emp_stat_id`, `emp_id`, `emp_status`, `processed_by`, `created_at`, `updated_at`) VALUES
(1, 3294, 'Regular', 298, '2023-11-16', '2023-11-16');
...
CREATE TABLE `emp_monthly_deduction_tbl` (
  ...
  `ded_month_id` smallint(6) NOT NULL,
  `ded_fiscal_year_id` int(11) NOT NULL,
...
--
-- Dumping data for table `emp_monthly_deduction_tbl`
--

INSERT INTO `emp_monthly_deduction_tbl` (`ded_id`, `ded_emp_id`, `ded_month_id`, `ded_fiscal_year_id`, `ded_deduction`, `processed_by`, `created_at`, `updated_at`) VALUES
(1, 3294, 10, 1, '500.00', 293, '2023-11-16', '2023-11-16');
...
--
-- Dumping data for table `emp_plantilla_tbl`
--

INSERT INTO `emp_plantilla_tbl` (`emp_plant_id`, `plant_id`, `emp_id`, `nbc_id`, `step`, `remarks`, `date_start`, `date_end`, `assigned_by`, `created_at`, `updated_at`) VALUES
(3, 14, 3294, 17, 1, 'NBC 511', '2015-11-01', '2023-10-31', 304, '2023-11-16', '2023-11-16');
...
INSERT INTO `emp_station_tbl` (`emp_st_id`, `st_id`, `st_emp_id`, `remarks`, `emp_st_assigned_by`, `created_at`, `updated_at`) VALUES
(1, 1, 3294, NULL, 288, '2023-11-16', '2023-11-16');
...
INSERT INTO `plantilla_tbl` (`plant_id`, `plantilla_item_no`, `position_title`, `salary_grade`, `date_recieved`, `created_at`, `updated_at`) VALUES
(11, '00221466545656', 'Teacher I', 11, '2023-11-01', '2023-11-16 01:02:21', '2023-11-16 01:02:21'),
...
CREATE TABLE `station_tbl` (
  `st_id` int(11) NOT NULL,
  `station_title` varchar(120) NOT NULL,
...
INSERT INTO `station_tbl` (`st_id`, `station_title`, `st_office_id`, `st_address`, `st_branch`, `st_created_by`, `created_at`, `updated_at`) VALUES
(1, 'Trinidad V. Canja - Sta. Teresa National High School', '302438', 'Jordan, Guimaras', 'National', 3414, '2023-11-01', '2023-11-01'),
(2, 'Jordan National High School', '302432', 'Jordan, Guimaras', 'National', 3414, '2023-11-01', '2023-11-01');
...
--
-- Indexes for table `employment_status_tble`
--
ALTER TABLE `employment_status_tble`
...
ALTER TABLE `emp_monthly_deduction_tbl`
  ...
  ADD KEY `ded_sy_id` (`ded_fiscal_year_id`),
  ADD KEY `processed_by` (`processed_by`),
  ADD KEY `ded_month_id` (`ded_month_id`);
...
--
-- AUTO_INCREMENT for table `employment_status_tble`
--
ALTER TABLE `employment_status_tble`
  MODIFY `emp_stat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `emp_monthly_deduction_tbl`
--
ALTER TABLE `emp_monthly_deduction_tbl`
  MODIFY `ded_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `emp_plantilla_tbl`
  MODIFY `emp_plant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `emp_station_tbl`
  MODIFY `emp_st_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `plantilla_tbl`
  MODIFY `plant_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Constraints for table `employment_status_tble`
--
ALTER TABLE `employment_status_tble`
  ADD CONSTRAINT `employment_status_tble_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employee_t` (`emp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `employment_status_tble_ibfk_2` FOREIGN KEY (`processed_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `emp_monthly_deduction_tbl`
  ...
  ADD CONSTRAINT `emp_monthly_deduction_tbl_ibfk_2` FOREIGN KEY (`ded_fiscal_year_id`) REFERENCES `fiscal_year_tbl` (`year_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `emp_monthly_deduction_tbl_ibfk_3` FOREIGN KEY (`processed_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `emp_monthly_deduction_tbl_ibfk_4` FOREIGN KEY (`ded_month_id`) REFERENCES `calendar_tbl` (`cal_id`) ON DELETE CASCADE ON UPDATE CASCADE;
