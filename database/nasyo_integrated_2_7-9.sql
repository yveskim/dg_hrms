...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2023 at 10:44 AM
...
(78, 3296, 3299, 30, 1, 1, '2023-07-07 17:20:31', '2023-07-07 17:20:31', NULL),
(84, 3297, 3310, 33, 1, 1, '2023-07-07 17:42:54', '2023-07-07 17:42:54', NULL);
...
(8, 219, 31, 1, 1, 274, '2023-07-07 12:25:50', '2023-07-07 12:25:50', NULL);
...
--
ALTER TABLE `enrollment_status_tbl`
  MODIFY `en_stat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;

--
-- AUTO_INCREMENT for table `enrollment_tbl`
--
ALTER TABLE `enrollment_tbl`
  MODIFY `en_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
...
--
ALTER TABLE `shs_section_adviser_tbl`
  MODIFY `shs_adv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `shs_section_tbl`
--
ALTER TABLE `shs_section_tbl`
  MODIFY `shs_sec_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `shs_student_section_tbl`
--
ALTER TABLE `shs_student_section_tbl`
  MODIFY `shs_stud_sec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `student_account_t`
  MODIFY `s_account_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
...
--
ALTER TABLE `student_parents_tbl`
  MODIFY `parent_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `student_school_tbl`
  MODIFY `sch_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `student_strands_tbl`
  MODIFY `stud_strand_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
