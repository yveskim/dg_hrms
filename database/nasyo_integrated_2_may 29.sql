...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2023 at 04:53 PM
...
(2, 3294, 1, '2023-04-19', 0, '2023-04-26 15:48:44', '2023-05-11 10:42:27'),
...
(7, 3294, 1, '2023-05-03', 1, '2023-05-11 10:42:25', '2023-05-11 10:42:27');
...
(11, 3295, 6, 1, '2023-04-29 21:59:55', '2023-05-07 11:59:34', NULL),
(14, 3297, 9, 1, '2023-05-02 13:24:02', '2023-05-12 15:24:54', NULL),
(21, 3296, 6, 1, '2023-05-08 16:36:15', '2023-05-08 16:36:20', NULL),
(23, 3299, 6, 1, '2023-05-29 14:48:10', '2023-05-29 14:48:10', NULL),
(24, 3294, 6, 1, '2023-05-29 14:48:57', '2023-05-29 14:48:57', NULL);
...
(138, '23-00001', '12345678910', 'Al John', 'Dela Cruz', 'Artacho', 'Male', '1990-05-02', 'fsdfsd', '', 'Filipino', 'Roman Catholic', '', 'b-', '45', '54', '09123456789', '033-320-4361', 'aljon.artacho@gmail.com', 'al john artacho', '1685072862_af221fb4145ec24fe386.jpg', 0, '', '2023-05-13 16:19:01', '2023-05-26 11:47:42', NULL),
...
(63, '23-00001', 'iloilonhs', 1, 0, 'student', 138, '2023-05-13 16:19:01', '2023-05-13 16:19:01'),
(65, '23-00003', 'iloilonhs', 1, 0, 'student', 140, '2023-05-13 16:28:18', '2023-05-13 16:28:18'),
...
(33, 6, 138, 1, 1, '2023-05-16 15:47:42', '2023-05-16 15:47:42'),
(34, 6, 149, 1, 1, '2023-05-26 13:52:53', '2023-05-26 13:52:53'),
(35, 6, 140, 1, 1, '2023-05-26 14:17:03', '2023-05-26 14:17:03');
...
--
ALTER TABLE `advisery_tbl`
  MODIFY `adv_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `employee_department_tbl`
  MODIFY `emp_dept_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `employee_program_tbl`
--
ALTER TABLE `employee_program_tbl`
  MODIFY `emp_prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `enrollment_status_tbl`
  MODIFY `en_stat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `enrollment_tbl`
--
ALTER TABLE `enrollment_tbl`
  MODIFY `en_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
...
--
ALTER TABLE `household_members_tbl`
  MODIFY `hm_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `section_details_tbl`
  MODIFY `sec_det_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `student_account_t`
  MODIFY `s_account_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `student_health_tbl`
  MODIFY `health_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `student_parents_tbl`
--
ALTER TABLE `student_parents_tbl`
  MODIFY `parent_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `student_program_tbl`
--
ALTER TABLE `student_program_tbl`
  MODIFY `stud_prog_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `student_school_tbl`
--
ALTER TABLE `student_school_tbl`
  MODIFY `sch_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
