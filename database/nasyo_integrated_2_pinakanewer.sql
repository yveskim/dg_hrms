...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2023 at 10:54 PM
...
(2, 3294, 1, '2023-04-19', 0, '2023-04-26 15:48:44', '2023-04-29 13:57:16'),
(4, 3295, 1, '2023-04-26', 0, '2023-04-26 22:23:28', '2023-04-29 13:57:16'),
(5, 3297, 1, '2023-04-23', 1, '2023-04-29 13:57:10', '2023-04-29 13:57:16');
...
(11, 3294, 3, 1, 1, '2023-04-19', 0, '2023-04-26 22:01:23', '2023-04-29 13:56:52'),
(12, 3295, 8, 1, 1, '2023-04-20', 0, '2023-04-26 22:24:08', '2023-04-29 13:56:52'),
(13, 3297, 2, 1, 1, '2023-04-21', 1, '2023-04-29 13:56:49', '2023-04-29 13:56:52');
...
CREATE TABLE `employee_program_tbl` (
  ...
  `date_assigned` date NOT NULL,
  `is_current` tinyint(1) NOT NULL,
  `memo_no` varchar(25) DEFAULT NULL,
  `is_ph` tinyint(1) NOT NULL,
...
INSERT INTO `employee_program_tbl` (`emp_prog_id`, `emp_id`, `prog_id`, `date_assigned`, `is_current`, `memo_no`, `is_ph`, `sy_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(11, 3295, 6, '2023-04-07', 1, '0976', 1, 1, '2023-04-29 21:59:55', '2023-04-29 22:29:20', NULL);
...
--
ALTER TABLE `employee_program_tbl`
  MODIFY `emp_prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `employee_t`
--
ALTER TABLE `employee_t`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3298;
...
--
ALTER TABLE `program_tbl`
  MODIFY `prog_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
