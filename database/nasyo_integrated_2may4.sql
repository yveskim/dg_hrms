...
(14, 3296, 2, 1, 1, '2023-05-02', 1, '2023-05-03 07:23:59', '2023-05-03 07:31:06'),
(15, 3299, 2, 1, 1, '2023-05-01', 1, '2023-05-03 13:09:12', '2023-05-03 13:09:41');
...
(12, 3294, 6, '2023-05-01', 1, 1, '2023-05-02 10:14:14', '2023-05-03 10:19:39', NULL),
...
(16, 3294, 7, '2023-05-12', 0, 1, '2023-05-02 13:28:04', '2023-05-03 10:19:39', NULL),
...
INSERT INTO `enrollment_status_tbl` (`en_stat_id`, `en_id`, `sy_id`, `enrollment_status`, `remarks`, `grade_level`, `cat_id`, `enrolled_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 130, 1, 'OE', 'New Student', 1, 1, 274, '2023-05-04 13:37:19', '2023-05-04 13:37:19', NULL),
(2, 131, 1, 'OE', 'New Student', 1, 1, 274, '2023-05-04 15:08:13', '2023-05-04 15:08:13', NULL);
...
INSERT INTO `program_head_tbl` (`ph_id`, `p_id`, `emp_id`, `date_assigned`, `memo_no`, `sy_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 6, 3295, '2023-05-05', '086774', 1, '2023-05-03 09:10:33', '2023-05-03 09:10:33', NULL),
(3, 9, 3296, '2023-05-01', '096867', 1, '2023-05-03 11:18:09', '2023-05-03 11:18:09', NULL),
(4, 7, 3299, '2023-05-03', '08976', 1, '2023-05-03 13:11:46', '2023-05-03 13:11:46', NULL);
...
(7, 7, 3294, 1, '2023-05-03 11:30:39', '2023-05-03 11:30:39', NULL),
...
INSERT INTO `student_program_tbl` (`stud_prog_id`, `prog_id`, `stud_id`, `date_assigned`, `is_active`, `sy_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 6, 130, '2023-05-04', 1, 1, '2023-05-04 15:06:28', '2023-05-04 15:06:28', NULL);
...
--
ALTER TABLE `educational_bg_t`
  MODIFY `educ_bg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `employee_position_tbl`
  MODIFY `emp_pos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `employee_program_tbl`
--
ALTER TABLE `employee_program_tbl`
  MODIFY `emp_prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `employee_t`
--
ALTER TABLE `employee_t`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3300;
...
--
ALTER TABLE `enrollment_status_tbl`
  MODIFY `en_stat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `enrollment_tbl`
--
ALTER TABLE `enrollment_tbl`
  MODIFY `en_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
...
--
ALTER TABLE `section_details_tbl`
  MODIFY `sec_det_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `section_tbl`
--
ALTER TABLE `section_tbl`
  MODIFY `sec_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `student_account_t`
--
ALTER TABLE `student_account_t`
  MODIFY `s_account_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `student_program_tbl`
--
ALTER TABLE `student_program_tbl`
  MODIFY `stud_prog_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `enrollment_status_tbl`
  ...
  ADD CONSTRAINT `enrollment_status_tbl_ibfk_4` FOREIGN KEY (`cat_id`) REFERENCES `category_tbl` (`cat_id`) ON DELETE CASCADE ON UPDATE CASCADE,
